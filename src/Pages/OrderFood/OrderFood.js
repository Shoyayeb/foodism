...
const OrderFood = () => {
    ...
    useEffect(() => {
        const url = `https://foodism.onrender.com/foods/${foodId}`;
    ...
    const handleBookService = (e) => {
        ...
        formData.userImage = user.photoURL || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80";
        ...
        axios
            .post("https://foodism.onrender.com/orderfood", formData)
            .then(function (res) {
                setOrdered(true);
            })
            ...
            <div className="mt-10 sm:mt-0 mx-8 my-8">
                <div className="md:grid md:grid-cols-5 md:gap-6">
                    <div className="md:col-span-2">
                        {loading ? <Spinner /> : <div className="px-4 sm:px-0">
